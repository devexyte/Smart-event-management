...
export const QRCodePassModal: React.FC<QRCodePassModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      <div className="bg-[#131d31] border border-slate-700 rounded-2xl max-w-md w-full p-6 shadow-2xl space-y-6">
        {/* Header */}
        ...
        {/* Ticket Card */}
        <div className="printable-pass bg-[#f8fafc] text-slate-900 rounded-xl p-6 border border-slate-300 shadow-md text-center space-y-4">
          ...
          {/* QR Code Container */}
          <div className="p-4 bg-white rounded-lg border border-slate-200 inline-block shadow-sm">
            <QRCodeSVG
        ...
        <div className="flex items-center justify-between gap-3 pt-1 no-print">
          <button
            onClick={handlePrint}
            className="flex-1 py-2.5 rounded-lg bg-blue-600 hover:bg-blue-500 text-white text-xs font-semibold shadow-sm transition-colors flex items-center justify-center gap-1.5"
          >
