    ...
    <div className="space-y-6">
      ...
      {bookmarkedEvents.length === 0 ? (
        <div className="bg-[#131d31] border border-slate-800 rounded-2xl p-12 text-center space-y-3">
          ...
          <h3 className="text-base font-semibold text-slate-300">No saved events yet</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {bookmarkedEvents.map((event) => {
            ...
            return (
              <div
                key={event.id}
                className="bg-[#131d31] border border-slate-800 rounded-2xl overflow-hidden shadow-sm flex flex-col justify-between"
              >
                <div className="relative h-40 overflow-hidden bg-slate-900">
                  ...
                  <span className="absolute top-3 left-3 text-[11px] font-semibold px-2.5 py-0.5 rounded bg-blue-600 text-white">
                    {event.category}
                  </span>
